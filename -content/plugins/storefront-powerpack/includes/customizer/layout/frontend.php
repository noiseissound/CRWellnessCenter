...
if ( ! class_exists( 'SP_Frontend_Layout' ) ) :
	...
	class SP_Frontend_Layout extends SP_Frontend {
		...
		public function __construct() {
			...
			add_filter( 'single_product_archive_thumbnail_size', array( $this, 'change_image_size' ) );
			add_filter( 'subcategory_archive_thumbnail_size', array( $this, 'change_image_size' ) );
			add_filter( 'woocommerce_gallery_image_size', array( $this, 'change_image_size' ) );
		}
		 ...
		 * @return string $size the new size.
		 * @since 1.4.5
		 */
