...
(function(a){jQuery(function(a){a("body").on("editing_module_option",function(a,c,e,d){"maps-pro"===c&&setTimeout(function(){"object"!==typeof google?Themify.LoadAsync("//maps.google.com/maps/api/js?sensor=false&callback=builderMapsProInit&key="+builderMapsPro.key,!1,!0,!0,function(){return"object"===typeof google&&"object"===typeof google.maps}):builderMapsProInit()},1E3)});a("body",top_iframe).on("change","#map_center, #zoom_map, #type_map, #style_map, #disable_map_ui, #map_polyline, #map_polyline_geodesic, #map_polyline_stroke, #map_polyline_color",
